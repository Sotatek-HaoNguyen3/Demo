...
const defaultProps = {
    ...
    scrollTo: null as OrNull<(e) => void>,
    scrollOffset: 0,
    scrollOffsetMax: 0,
...
export class BaseModal extends React.Component<BaseModalProps, State> {
        ...
        this.panResponder = PanResponder.create({
            ...
            onStartShouldSetPanResponder: (e: any, gestureState) => {
                const hasScrollableView =
                    ...
                    e._dispatchInstances.some((instance: any) => /scrollview|flatlist/i.test(instance.type));
    ...
    makeBackdrop = () => {
        ...
        const { customBackdrop, backdropColor, useNativeDriver, useNativeDriverForBackdrop, onBackdropPress } =
            this.props;
        ...
        const backdropWrapper = (
            <animatable.View
                ...
                useNativeDriver={
                    useNativeDriverForBackdrop !== undefined ? useNativeDriverForBackdrop : useNativeDriver
                }
    ...
    render() {
        ...
        const _children =
            this.props.hideModalContentWhileAnimating && this.props.useNativeDriver && !this.state.showContent ? (
                <animatable.View />
            ) : (
                children
            );
