...
export default class Arc extends Component<IArcProps> {
    static propTypes = {
    ...
    render() {
        const { startAngle, endAngle, radius, offset, direction, strokeCap, strokeWidth, ...restProps } = this.props;
        ...
        return <Path d={path} strokeLinecap={strokeCap} strokeWidth={strokeWidth} {...restProps} />;
    }
}
