...
import { BaseTheme, Dimensions, RestyleFunction, RestyleFunctionContainer, RNStyle } from './types';

const composeRestyleFunctions = <Theme extends BaseTheme, TProps extends AllProps<Theme>>(
    restyleFunctions: (RestyleFunctionContainer<TProps, Theme> | RestyleFunctionContainer<TProps, Theme>[])[]
) => {
