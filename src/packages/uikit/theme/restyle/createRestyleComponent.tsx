...
const createRestyleComponent = <Props extends { [key: string]: any }, Theme extends BaseTheme>(
    restyleFunctions: (RestyleFunctionContainer<Props, Theme> | RestyleFunctionContainer<Props, Theme>[])[],
