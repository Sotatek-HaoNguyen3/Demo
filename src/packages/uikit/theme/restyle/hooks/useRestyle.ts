...
import { BaseTheme, Dimensions, RNStyle } from '../types';

const filterRestyleProps = <TRestyleProps, TProps extends { [key: string]: unknown } & TRestyleProps>(
...
>(
    ...
    const dimensions = theme.breakpoints ? useWindowDimensions() : null;
    ...
    }, [theme, dimensions, props.style, serializedRestyleProps, composedRestyleFunction]);
