...
import { Dimensions, PropValue, ResponsiveBaseTheme, ResponsiveValue, StyleTransformFunction } from '../types';
...
): (K extends keyof Theme ? ValueOf<Theme[K]> : never) | TVal | null | undefined => {
